...
public class SearchServiceImpl implements SearchService {
    ...
    @Override
    public ZillowResult search(String city, String content, int page, int rows) {
        List<Item4ES> item4ESList = searchDao.pageQuery(city, content, page, rows);
    ...
    public void ESInit() {
        ...
        for (Item item : itemList) {
            ...
            item4ES.setAptType(item.getAptType());
